      ...
      <footer className="border-stroke dark:border-strokedark dark:bg-blacksection border-t bg-white">
        <div className="max-w-c-1390 mx-auto px-4 md:px-8 2xl:px-0">
          ...
          <div className="border-stroke dark:border-strokedark flex flex-col flex-wrap items-center justify-center gap-5 border-t py-7 lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} RedEveloper. Todos os direitos reservados.
              </p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a target="_blank" href="https://www.facebook.com/profile.php?id=100063838823320"  aria-label="social icon">
                    <svg
                ...
                <li>
                  <a href="https://www.linkedin.com/company/redeveloper/?viewAsMember=true" target="_blank" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
