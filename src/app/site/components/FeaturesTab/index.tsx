      ...
      <section className="pt-18.5 lg:pb-22.5 relative pb-20">
        <div className="max-w-c-1390 relative mx-auto px-4 md:px-8 2xl:px-0">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="animate_top mb-15 border-stroke shadow-solid-5 dark:border-strokedark dark:bg-blacksection dark:shadow-solid-6 lg:gap-7.5 xl:mb-21.5 xl:gap-12.5 flex flex-wrap justify-center rounded-[10px] border bg-white md:flex-nowrap md:items-center"
          >
            <div
            ...
            >
              <div className="h-12.5 w-12.5 border-stroke dark:border-strokedark dark:bg-blacksection flex items-center justify-center rounded-[50%] border">
