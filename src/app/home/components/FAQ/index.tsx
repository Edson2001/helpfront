      ...
      <section className="lg:pb-25 xl:pb-30 overflow-hidden pb-20">
        <div className="max-w-c-1235 relative mx-auto px-4 md:px-8 xl:px-0">
          ...
          <div className="xl:gap-32.5 flex flex-wrap gap-8 md:flex-nowrap md:items-center">
            ...
            >
              <span className="font-medium uppercase mb-6 text-black dark:text-white">
                DÚVIDAS FREQUENTES
              </span>
              <h2 className="xl:text-hero mt-6 relative mb-6 text-3xl font-bold text-black dark:text-white">
                <span className="mb-6 flex">Perguntas</span>
              ...
              <a
                href="/contato" // Atualize para um link de contato ou documentação
